...
import com.webcontrol.controlbus.Prueba;

public class HiloValidarConexion extends AsyncTask<String, Void, String> {
	...
	public HiloValidarConexion(Context contexto, Activity actividad,
	...
	protected void onPostExecute(String result) {
		...
		if (_Exception == null) {
			_Progress.dismiss();
			Manager.InsertarDatosConfig(_NAMESPACE, _URL, _UsuarioWs,
					_ContraseniaWs, _Autentificacion);

			activity.finish();
			activity.startActivity(new Intent(context, MenuPrincipal
					.class));
